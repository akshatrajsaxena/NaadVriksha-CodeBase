# music_config.py
"""
Musical Configuration System
Allows easy customization of weather-to-music mappings
"""
...
class MusicConfig:
    """Configuration manager for musical parameters"""
    ...
    def _get_default_config(self):
        """Get default musical configuration"""
        return {
            "weather_mappings": {
                "Sunny": {
                    "base_note": 60,  # C4
                ...
                "Rainy": {
                    ...
                    "mood": "melancholic and flowing"
                },
                "Stormy": {
                    "base_note": 55,  # G3
                    "scale": [0, 1, 3, 5, 6, 8, 10],  # Phrygian mode
                    "scale_name": "G Phrygian",
                    ...
                    "octave_range": [2, 3, 4],
                    "rhythm_pattern": [1, 1, 0, 1, 1, 0, 1, 1],
                ...
                "Windy": {
                    ...
                    "octave_range": [4, 5, 6, 7],
                    "rhythm_pattern": [1, 0, 1, 1, 0, 1, 0, 1],
                    "mood": "ethereal and floating"
                }
            },
            "general_settings": {
                "sequence_length": 20,
    ...
    def get_weather_config(self, weather_class):
        """Get configuration for a specific weather class"""
        return self.config["weather_mappings"].get(weather_class, 
                                                   self.config["weather_mappings"]["Sunny"])
    ...
    def get_chord_intervals(self, chord_type):
        """Get chord intervals from chord type"""
    ...
    def update_weather_config(self, weather_class, updates):
        """Update configuration for a weather class"""
    ...
    def add_custom_weather(self, weather_class, config):
        """Add a new weather class configuration"""
...
class ConfigEditor:
    ...
    def edit_weather_class(self):
        """Edit an existing weather class"""
    ...
    def edit_weather_parameters(self, weather_class):
        """Edit parameters for a specific weather class"""
    ...
    def add_weather_class(self):
        ...
        # Copy from existing class as template
        weather_classes = list(self.config.config["weather_mappings"].keys())
...
def main():
    ...
    # Uncomment the next line to run interactive editor
